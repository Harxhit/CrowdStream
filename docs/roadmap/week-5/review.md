...
- [x] **Day 4** — Token-bucket rate limits + moderation pipeline (instant cross-pod enforcement)
...
- [x] Rate limits reject abuse with backoff; bans enforced everywhere fast
...
- [ ] Stress test messaging *(Week 6 — completing load testing.)*
